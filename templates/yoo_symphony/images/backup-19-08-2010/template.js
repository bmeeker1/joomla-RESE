...
var YOOTemplate = {
	...
	start: function() {
		...
		new YOOMorph('div#menu .hover-box11', menuEnter, menuLeave,
			{ transition: Fx.Transitions.linear, duration: 0, ignore: 'div#menu li li.separator .hover-box11, div#menu .mod-dropdown .hover-box11' },
